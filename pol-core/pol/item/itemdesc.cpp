  ...
  namespace Items {
	  ...
	  save_on_exit( elem.remove_bool( "SaveOnExit", true ) )
	{
      ...
      for ( unsigned resist = 0; resist <= Core::ELEMENTAL_TYPE_MAX; ++resist )
	  {
		...
		switch ( resist )
		{
          case Core::ELEMENTAL_FIRE: passed = elem.remove_prop( "FIRERESIST", &tmp ); break;
          case Core::ELEMENTAL_COLD: passed = elem.remove_prop( "COLDRESIST", &tmp ); break;
          case Core::ELEMENTAL_ENERGY: passed = elem.remove_prop( "ENERGYRESIST", &tmp ); break;
          case Core::ELEMENTAL_POISON: passed = elem.remove_prop( "POISONRESIST", &tmp ); break;
          case Core::ELEMENTAL_PHYSICAL: passed = elem.remove_prop( "PHYSICALRESIST", &tmp ); break;
		}
		...
		if ( passed )
		{
		  ...
		  switch ( resist )
		  {
            case Core::ELEMENTAL_FIRE: element_resist.fire = dice.roll( ); break;
            case Core::ELEMENTAL_COLD: element_resist.cold = dice.roll( ); break;
      ...
      for ( unsigned edamage = 0; edamage <= Core::ELEMENTAL_TYPE_MAX; ++edamage )
	  {
		...
		switch ( edamage )
		{
          case Core::ELEMENTAL_FIRE: passed = elem.remove_prop( "FIREDAMAGE", &tmp ); break;
          case Core::ELEMENTAL_COLD: passed = elem.remove_prop( "COLDDAMAGE", &tmp ); break;
          case Core::ELEMENTAL_ENERGY: passed = elem.remove_prop( "ENERGYDAMAGE", &tmp ); break;
          case Core::ELEMENTAL_POISON: passed = elem.remove_prop( "POISONDAMAGE", &tmp ); break;
          case Core::ELEMENTAL_PHYSICAL: passed = elem.remove_prop( "PHYSICALDAMAGE", &tmp ); break;
		}
		...
		if ( passed )
		{
		  ...
		  switch ( edamage )
		  {
            case Core::ELEMENTAL_FIRE: element_damage.fire = dice.roll( ); break;
            case Core::ELEMENTAL_COLD: element_damage.cold = dice.roll( ); break;
            case Core::ELEMENTAL_ENERGY: element_damage.energy = dice.roll( ); break;
            case Core::ELEMENTAL_POISON: element_damage.poison = dice.roll( ); break;
