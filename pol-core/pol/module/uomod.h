...
#	pragma pack()
	...
	public:
	  ...
	  Bscript::BObjectImp* mf_PlayMovingEffect_Ex(/*src,dst,effect,speed,duration,hue,render,direction,explode,effect3d*/ );
	  Bscript::BObjectImp* mf_PlayMovingEffectXyz_Ex(/*sx,sy,sz,dx,dy,dz,realm,effect,speed,duration,hue,render,direction,explode,effect3d*/ );
	  Bscript::BObjectImp* mf_PlayObjectCenteredEffect_Ex(/*src,effect,speed,duration,hue,render,layer,explode,effect3d*/ );
	  Bscript::BObjectImp* mf_PlayStationaryEffect_Ex(/*x,y,z,realm,effect,speed,duration,hue,render,layer,explode,effect3d*/ );
