...
namespace Pol {
  namespace Core {
	enum PKTBOTHID
	{
	  ...
	  PKTBI_98_IN_ID = 0x98,	// All Names Macro FIXME: This is a nasty kludge due to message handler using struct name+_id to get this. Boooooooo.
	  PKTBI_98_OUT_ID = 0x98,	// All Names Macro FIXME: This is a nasty kludge due to message handler using struct name+_id to get this. Boooooooo.
